...
**Decisão:** ponteiro para módulo canônico **não** mantém resumo do que o módulo cobre. Quem quer saber o escopo abre o módulo — é literalmente o que o ponteiro existe pra dizer. Vale para qualquer ritual da Parte 2 e para qualquer superfície que aponte para módulo. Antes de apagar um resumo existente, conferir bullet a bullet que o conteúdo está no módulo apontado; o que só existir no ponteiro **migra** em vez de sumir.
