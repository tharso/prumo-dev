...
**Relações com decisões anteriores:** **estende 2026-07-27 (#242 quarentena universal — a máquina `confirmar → registrar → mover → verificar` é dela; esta decisão põe a `decidir` obedecendo à máquina existente e acrescenta o elo final: a baixa no ledger, depois da verificação)**; complementa 2026-07-25 (#214/#217/#218/#211 conformidade detectável — a baixa vira passo verificável, na mesma família); mantém 2026-07-24 (#194 perímetro de leitura — o recorte delimitado é a mesma filosofia aplicada a arquivo grande). Nenhuma revogação identificada após consulta ao índice temático.
