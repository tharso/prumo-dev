...
1. **Perímetro automático:** por iniciativa própria, opere apenas nos caminhos do mapa acima. Zero exploração espontânea da raiz — **inclusive na descoberta**: as pastas do Prumo são sempre `Prumo/` e `.prumo/`; vá direto a elas, nunca liste a raiz pra "descobrir o workspace".
