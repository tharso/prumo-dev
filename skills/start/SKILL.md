...
- Rituais recorrentes: **com** hora → oferecer agenda (ver `../prumo/references/modules/escrita-calendario.md`); **sem** hora → `Agente/ROTINA.md` (contexto); se **não muda nenhuma decisão** → não registrar (poda). Não vão para "Agendado" — ritual não é pendência repetida.
- Ideias → IDEIAS.md
