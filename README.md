...
O corte de layout do workspace ja saiu do modo planta e entrou em codigo: `setup` cria workspaces novos no layout nested, e `migrate` ja faz o transplante flat -> nested sem vandalismo. O novo gargalo ficou mais honesto e menos glamouroso: fazer a primeira sessao em workspace novo parecer produto, nao encanamento. A espinha disso agora tambem esta em [WORKSPACE-LAYOUT-AND-ADOPTION-PLAN.md](/Users/tharsovieira/Documents/DailyLife/Prumo/WORKSPACE-LAYOUT-AND-ADOPTION-PLAN.md) e no contrato de kickoff em [canon/orchestration/kickoff.md](/Users/tharsovieira/Documents/DailyLife/Prumo/canon/orchestration/kickoff.md). E a direcao do kickoff ficou clara: menos formulario disfarçado, mais despejo assistido com organizacao progressiva e devolucao curta em blocos uteis.
