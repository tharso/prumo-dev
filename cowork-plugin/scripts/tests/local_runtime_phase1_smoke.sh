...
assert_contains "$TMP_DIR/briefing.out" "3. Agenda:" "briefing nao trouxe agenda consolidada"
assert_contains "$TMP_DIR/briefing.out" "Jantar de teste" "briefing nao incorporou snapshot dual"
assert_contains "$TMP_DIR/briefing.out" "4. Inbox mobile:" "briefing nao trouxe bloco de inbox mobile"
assert_contains "$TMP_DIR/briefing.out" "inbox-preview.html" "briefing nao linkou o preview do inbox"
assert_contains "$TMP_DIR/briefing.out" "5. Emails:" "briefing nao trouxe bloco de emails"
...
assert_contains "$TMP_DIR/briefing.out" "6. Panorama local:" "briefing nao trouxe panorama local"
assert_contains "$TMP_DIR/briefing.out" "7. Proposta do dia:" "briefing nao chegou ao bloco final com numeracao continua"
